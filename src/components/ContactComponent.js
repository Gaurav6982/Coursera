                                    ...
                                    <Control.text model=".first" id="firstname" name="firstname"
                                        ...
                                        <Errors
                                            ...
                                            messages={{
                                                ...
                                                maxLength:'First Name Should be Atmost 15 Characters ,',
                                            }}
                                        />
                                </Col>
                            </Row>
                                    ...
                                    <Control.text model=".last" id="lastname" name="lastname"
                                        ...
                                        <Errors
                                            ...
                                            messages={{
                                                ...
                                                maxLength:'Last Name Should be Atmost 15 Characters ,',
                                            }}
                                        />
                                </Col>                        
                            </Row>
                            ...
                            <Label htmlFor="telnum" md={2}>Contact Tel.</Label>
                                <Col md={10}>
                                    ...
                                    <Errors
                                        ...
                                        messages={{
                                            required:'Required ,',
                                            minLength:'Tel Number Should be Atleast 10 Characters ,',
                                            maxLength:'Tel Number Should be Atmost 10 Characters ,',
                                            isNumber:'Tel Number Should be Number only'
                                        }}
                                    />
                                </Col>
                            </Row>
